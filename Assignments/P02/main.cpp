...
* 
*  Description:
*        Continue with the Vector class from the previous exercise. This time,
*          we will implement the overloaded operators for the Vector class.
*           The overloaded operators are: +,-,*,/,==,[],<<,=
*        
*       
*  Files:            
*       main.cpp      : driver program 
*       output.txt   : Files contain the output of the program
*****************************************************************************/
